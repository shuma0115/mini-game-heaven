...
const I18N = {
  ...
  en: {
    ...
    "meta.minesweeper": "A minesweeper mini game where you open all safe cells.",
    ...
    "index.game.minesweeper.desc": "A puzzle game where you open all safe cells by reading number hints.",
    ...
    "minesweeper.desc": "Open all safe cells without hitting mines.",
    ...
    "minesweeper.time.unit": "s",
    "minesweeper.status.ready": "Ready",
    "minesweeper.status.play": "Playing",
    "minesweeper.status.win": "You win!",
    "minesweeper.status.lose": "Game over",
    "minesweeper.tip.html": "• Left click: open / Right click: flag<br>• Open all safe cells to win.",
    "minesweeper.guide.title": "Game Guide",
    "minesweeper.guide.desc": "Quick rules and tips for minesweeper.",
    "minesweeper.guide.rules.title": "Rules",
    "minesweeper.guide.rules.li1": "Numbers show how many mines are in the 8 surrounding cells.",
  ...
  ja: {
    ...
    "aria.terms": "利用規約",
    "meta.index": "じゃんけん、五目並べ、ロト抽選、メニューおすすめを一つの場所で楽しめるミニゲームサイトです。",
    "meta.rps": "じゃんけんミニゲームのルール、戦略、対戦記録を紹介するページです。",
    "meta.omok": "五目並べミニゲームの勝利条件と基本戦術を紹介するページです。",
    "meta.lotto": "ロト番号抽選と使い方、確率の注意点を案内するページです。",
    "meta.menu": "ランダムに昼食・夕食メニューをおすすめするミニゲームです。",
    "meta.minesweeper": "地雷を避けて安全なマスを開くマインスイーパーミニゲームです。",
    "meta.about": "ミニゲーム天国の目的と運営方針、更新計画を紹介します。",
    ...
    "index.select.title": "ゲームを選ぶ",
    "index.select.desc": "遊びたいミニゲームを選んでください。",
    ...
    "index.desc.title": "ゲーム概要",
    "index.desc.desc": "各ゲームの基本ルールと勝利条件を確認できます。",
    "index.game.rps.title": "じゃんけん",
    "index.game.rps.desc": "グー・チョキ・パーから一つ選んで勝負します。同じ選択は引き分け、相手に勝てば勝利です。",
    "index.game.omok.title": "五目並べ",
    "index.game.omok.desc": "盤上に石を交互に置き、縦・横・斜めに5つ並べた方が勝ちです。",
    "index.game.lotto.title": "ロト抽選",
    "index.game.lotto.desc": "1〜45の数字から重複なく6つをランダムで抽選する番号おすすめゲームです。",
    "index.game.menu.title": "何を食べよう？",
    "index.game.menu.desc": "ボタン一つで昼食・夕食メニューをランダムにおすすめします。",
    "index.game.minesweeper.title": "マインスイーパー",
    "index.game.minesweeper.desc": "数字のヒントを読み取り、地雷を避けて安全なマスを開くパズルゲームです。",
    "index.site.title": "サイト案内",
    "index.site.desc": "コンテンツ品質とユーザー体験を最優先に運営しています。",
    "index.site.principles.title": "コンテンツ方針",
    "index.site.principles.li1": "自作のミニゲームと説明を提供します。",
    "index.site.principles.li2": "各ページにルール・ヒント・FAQを掲載しています。",
    "index.site.principles.li3": "広告は体験を損なわない位置のみに配置します。",
    "index.site.tech.title": "技術とアクセシビリティ",
    "index.site.tech.li1": "PC/モバイルの両方で快適に動作するレスポンシブ構成です。",
    "index.site.tech.li2": "ローカル環境でも動作し、個人情報の収集は最小限に抑えます。",

    "rps.title": "じゃんけん",
    "rps.desc": "グー・チョキ・パーから一つ選んで勝負します。同じ選択は引き分け、相手に勝てば勝利です。",
    "rps.reset": "記録リセット",
    "rps.my": "自分",
    "rps.cpu": "相手",
    ...
    "rps.log.me": "自分",
    "rps.log.cpu": "相手",
    "rps.tip.html": "ヒント: <span class=\"kbd\">R</span> 記録リセット / <span class=\"kbd\">ESC</span> ホーム",
    "rps.history.title": "対戦履歴",
    "rps.history.empty": "まだ履歴がありません。",
    "rps.history.hint": "履歴はlocalStorageに保存されます。",
    "rps.guide.title": "ゲームガイド",
    "rps.guide.desc": "ルール、勝利条件、ヒントをまとめました。",
    "rps.guide.rules.title": "ルール",
    "rps.guide.rules.li1": "グーはチョキに勝ち、チョキはパーに勝ち、パーはグーに勝ちます。",
    "rps.guide.rules.li2": "同じ選択は引き分けです。",
    "rps.guide.rules.li3": "記録はlocalStorageに保存されます。",
    "rps.guide.tips.title": "コツ",
    "rps.guide.tips.li1": "連敗後はパターンを崩す選択を試しましょう。",
    "rps.guide.tips.li2": "履歴を確認して傾向を分析できます。",

    "omok.title": "五目並べ",
    "omok.desc": "盤上に石を交互に置き、縦・横・斜めに5つ並べた方が勝ちです。",
    "omok.level": "難易度:",
    "omok.level.easy": "簡単",
    "omok.level.normal": "普通",
    "omok.level.hard": "難しい",
    "omok.canvas.label": "五目盤",
    "omok.hint.html": "• 難易度は即時適用されます（次のAIの手から）。<br>• <span class=\"kbd\">ESC</span> ホーム",
    "omok.turn.user": "あなたの番({color})",
    "omok.turn.ai": "AIの番({color})",
    "omok.history.empty": "まだ着手がありません",
    "omok.player.user": "{color} (あなた)",
    "omok.player.ai": "{color} (AI)",
    "omok.win.user": "あなたの勝ち!",
    "omok.win.ai": "AIの勝ち!",
    "omok.color.black": "黒",
    "omok.color.white": "白",
    "omok.undo": "戻す",
    ...
    "omok.shortcuts.html": "• 難易度は即時適用されます（次のAIの手から）。<br>• <span class=\"kbd\">U</span>: 戻す / <span class=\"kbd\">N</span>: 新しいゲーム / <span class=\"kbd\">ESC</span>: ホーム",
    ...
    "omok.guide.rules.title": "ルール",
    "omok.guide.rules.li1": "縦・横・斜めに5つ並べると勝ちです。",
    "omok.guide.rules.li2": "1ターンに1手置けます。",
    "omok.guide.rules.li3": "中央を取ると展開の幅が広がります。",
    "omok.guide.tips.title": "コツ",
    ...
    "lotto.desc.sub": "抽選ボタンを押すと複数セットが自動生成されます。",
    "lotto.set": "セット",
    "lotto.btn.pick": "🎲 番号を抽選",
    "lotto.btn.copy": "📋 現在結果をコピー",
    "lotto.btn.reset": "現在画面をリセット",
    ...
    "lotto.hint.html": "• 履歴はlocalStorageに保存されます。<br/>• 「履歴を全削除」は元に戻せません。<br/>• <span class=\"kbd\">ESC</span> ホーム",
    "lotto.guide.title": "ゲームガイド",
    "lotto.guide.desc": "抽選方式と使い方をまとめました。",
    ...
    "lotto.guide.tips.title": "コツ",
    "lotto.guide.tips.li1": "複数セットを比較して多様性を高めましょう。",
    "lotto.guide.tips.li2": "同じ数字パターンの繰り返しは避けましょう。",

    "menu.title": "何を食べよう？",
    "menu.sub": "昼・夜のメニューをランダムにおすすめします。",
    "menu.button.pick": "🍽️ メニューをおすすめ",
    "menu.result.prompt": "ボタンを押してください",
    "menu.result.choosing": "選んでいます…",
    "menu.hero.title": "メニューおすすめゲーム",
    "menu.hero.desc": "ボタンを押すと今日のメニューを1つ提案します。",
    "menu.guide.title": "おすすめガイド",
    "menu.guide.desc": "おすすめ方法と活用のコツを確認できます。",
    "menu.guide.rules.title": "おすすめ方法",
    "menu.guide.rules.li1": "メニュー一覧からランダムに1つ選びます。",
    "menu.guide.tips.title": "コツ",
    "menu.guide.tips.li1": "チームのランチ前に使うとすぐ決まります。",
    "menu.guide.tips.li2": "3〜5個まで候補を絞って決めましょう。",

    "minesweeper.title": "マインスイーパー",
    "minesweeper.desc": "地雷を避けて安全なマスを開きましょう。",
    ...
    "privacy.collect.li2": "ゲーム記録/設定はlocalStorageに保存されます。",
    ...
    "contact.info.li2": "可能であれば使用ブラウザとページ名をお知らせください。",
    "contact.response.title": "返信の目安",
    "contact.response.li1": "平日1〜3日以内の回答を目指します。",
    "contact.response.li2": "受付順に反映します。"
  }
};
