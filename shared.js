...
const I18N = {
  ko: {
    ...
    "meta.minesweeper": "지뢰를 피해 모든 안전 칸을 여는 지뢰찾기 미니게임입니다.",
    ...
    "index.game.minesweeper.desc": "지뢰를 피해 숫자 힌트를 해석하며 모든 안전 칸을 여는 퍼즐 게임입니다.",
    ...
    "minesweeper.desc": "지뢰를 피해 모든 안전 칸을 열어보세요.",
    ...
    "minesweeper.tip.html": "• 좌클릭: 열기 / 우클릭: 깃발<br>• 모든 안전 칸을 열면 승리합니다.",
    ...
    "minesweeper.guide.rules.li3": "모든 안전 칸을 열면 승리합니다.",
